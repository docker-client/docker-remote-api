...
data class ContainerUpdateRequest(
  ...
  var blkioWeightDevice: kotlin.collections.List<ResourcesBlkioWeightDevice>? = null,
  /* Limit read rate (bytes per second) from a device, in the form:  ``` [{\"Path\": \"device_path\", \"Rate\": rate}] ```  */
  @Json(name = "BlkioDeviceReadBps")
  var blkioDeviceReadBps: kotlin.collections.List<ThrottleDevice>? = null,
  /* Limit write rate (bytes per second) to a device, in the form:  ``` [{\"Path\": \"device_path\", \"Rate\": rate}] ```  */
  @Json(name = "BlkioDeviceWriteBps")
  var blkioDeviceWriteBps: kotlin.collections.List<ThrottleDevice>? = null,
  /* Limit read rate (IO per second) from a device, in the form:  ``` [{\"Path\": \"device_path\", \"Rate\": rate}] ```  */
  @Json(name = "BlkioDeviceReadIOps")
  var blkioDeviceReadIOps: kotlin.collections.List<ThrottleDevice>? = null,
  /* Limit write rate (IO per second) to a device, in the form:  ``` [{\"Path\": \"device_path\", \"Rate\": rate}] ```  */
  @Json(name = "BlkioDeviceWriteIOps")
  var blkioDeviceWriteIOps: kotlin.collections.List<ThrottleDevice>? = null,
  ...
  @Json(name = "Devices")
  var devices: kotlin.collections.List<DeviceMapping>? = null,
  /* a list of cgroup rules to apply to the container */
  @Json(name = "DeviceCgroupRules")
  var deviceCgroupRules: kotlin.collections.List<kotlin.String>? = null,
  /* A list of requests for devices to be sent to device drivers.  */
  @Json(name = "DeviceRequests")
  var deviceRequests: kotlin.collections.List<DeviceRequest>? = null,

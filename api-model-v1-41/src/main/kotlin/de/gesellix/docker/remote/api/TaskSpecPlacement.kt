...
data class TaskSpecPlacement(
  ...
  var constraints: kotlin.collections.List<kotlin.String>? = null,
  /* Preferences provide a way to make the scheduler aware of factors such as topology. They are provided in order from highest to lowest precedence.  */
  @Json(name = "Preferences")
  var preferences: kotlin.collections.List<TaskSpecPlacementPreferences>? = null,
  /* Maximum number of replicas for per node (default value is 0, which is unlimited)  */
  @Json(name = "MaxReplicas")
  var maxReplicas: kotlin.Long? = null,
  ...
  @Json(name = "Platforms")
  var platforms: kotlin.collections.List<Platform>? = null
)

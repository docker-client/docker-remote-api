...
data class SystemInfo(
  ...
  var driverStatus: kotlin.collections.List<kotlin.collections.List<kotlin.String>>? = null,
  ...
  var indexServerAddress: kotlin.String? = null,
  ...
  @Json(name = "Labels")
  var labels: kotlin.collections.List<kotlin.String>? = null,
  ...
  /* List of [OCI compliant](https://github.com/opencontainers/runtime-spec) runtimes configured on the daemon. Keys hold the \"name\" used to reference the runtime.  The Docker daemon relies on an OCI compliant runtime (invoked via the `containerd` daemon) as its interface to the Linux kernel namespaces, cgroups, and SELinux.  The default runtime is `runc`, and automatically configured. Additional runtimes can be configured by the user and will be listed here.  */
  @Json(name = "Runtimes")
  var runtimes: kotlin.collections.Map<kotlin.String, Runtime>? = null,
  ...
  var defaultRuntime: kotlin.String? = null,
  @Json(name = "Swarm")
  ...
  var liveRestoreEnabled: kotlin.Boolean? = null,
  ...
  var securityOptions: kotlin.collections.List<kotlin.String>? = null,
  ...
  var defaultAddressPools: kotlin.collections.List<SystemInfoDefaultAddressPools>? = null,

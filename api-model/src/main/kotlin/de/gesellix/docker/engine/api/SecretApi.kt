...
class SecretApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun secretCreate(body: UNKNOWN_BASE_TYPE?): IdResponse {
    ...
    val localVarResponse = request<UNKNOWN_BASE_TYPE, IdResponse>(
      localVariableConfig
    )
   ...
   */
  fun secretCreateRequestConfig(body: UNKNOWN_BASE_TYPE?): RequestConfig<UNKNOWN_BASE_TYPE> {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun secretDelete(id: kotlin.String) {
   ...
   * @return RequestConfig
   */
  fun secretDeleteRequestConfig(id: kotlin.String): RequestConfig<Unit> {
  ...
  fun secretInspect(id: kotlin.String): Secret {
    ...
    val localVarResponse = request<Unit, Secret>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun secretInspectRequestConfig(id: kotlin.String): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
  ...
  fun secretList(filters: kotlin.String?): kotlin.collections.List<Secret> {
    ...
    val localVarResponse = request<Unit, kotlin.collections.List<Secret>>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun secretListRequestConfig(filters: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun secretUpdate(id: kotlin.String, version: kotlin.Long, body: SecretSpec?) {
    val localVariableConfig = secretUpdateRequestConfig(id = id, version = version, body = body)

    val localVarResponse = request<SecretSpec, Unit>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun secretUpdateRequestConfig(id: kotlin.String, version: kotlin.Long, body: SecretSpec?): RequestConfig<SecretSpec> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {

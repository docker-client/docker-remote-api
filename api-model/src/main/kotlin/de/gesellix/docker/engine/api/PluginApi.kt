...
class PluginApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun getPluginPrivileges(remote: kotlin.String): kotlin.collections.List<PluginPrivilegeItem> {
    ...
    val localVarResponse = request<Unit, kotlin.collections.List<PluginPrivilegeItem>>(
      localVariableConfig
    )
   ...
   */
  fun getPluginPrivilegesRequestConfig(remote: kotlin.String): RequestConfig<Unit> {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun pluginCreate(name: kotlin.String, tarContext: java.io.File?) {
   ...
   * @return RequestConfig
   */
  fun pluginCreateRequestConfig(name: kotlin.String, tarContext: java.io.File?): RequestConfig<java.io.File> {
   ...
   * @return RequestConfig
   */
  fun pluginDeleteRequestConfig(name: kotlin.String, force: kotlin.Boolean?): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        if (force != null) {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun pluginDisable(name: kotlin.String) {
   ...
   * @return RequestConfig
   */
  fun pluginDisableRequestConfig(name: kotlin.String): RequestConfig<Unit> {
    val localVariableBody = null
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun pluginEnable(name: kotlin.String, timeout: kotlin.Int?) {
   ...
   * @return RequestConfig
   */
  fun pluginEnableRequestConfig(name: kotlin.String, timeout: kotlin.Int?): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        if (timeout != null) {
   ...
   * @return RequestConfig
   */
  fun pluginInspectRequestConfig(name: kotlin.String): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
  ...
  fun pluginList(filters: kotlin.String?): kotlin.collections.List<Plugin> {
    ...
    val localVarResponse = request<Unit, kotlin.collections.List<Plugin>>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun pluginListRequestConfig(filters: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        if (filters != null) {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun pluginPull(remote: kotlin.String, name: kotlin.String?, xRegistryAuth: kotlin.String?, body: kotlin.collections.List<InlineObject>?) {
    val localVariableConfig = pluginPullRequestConfig(remote = remote, name = name, xRegistryAuth = xRegistryAuth, body = body)

    val localVarResponse = request<kotlin.collections.List<InlineObject>, Unit>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun pluginPullRequestConfig(remote: kotlin.String, name: kotlin.String?, xRegistryAuth: kotlin.String?, body: kotlin.collections.List<InlineObject>?): RequestConfig<kotlin.collections.List<InlineObject>> {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun pluginPush(name: kotlin.String) {
   ...
   * @return RequestConfig
   */
  fun pluginPushRequestConfig(name: kotlin.String): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun pluginSet(name: kotlin.String, body: kotlin.collections.List<kotlin.String>?) {
    val localVariableConfig = pluginSetRequestConfig(name = name, body = body)

    val localVarResponse = request<kotlin.collections.List<kotlin.String>, Unit>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun pluginSetRequestConfig(name: kotlin.String, body: kotlin.collections.List<kotlin.String>?): RequestConfig<kotlin.collections.List<kotlin.String>> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun pluginUpgrade(name: kotlin.String, remote: kotlin.String, xRegistryAuth: kotlin.String?, body: kotlin.collections.List<InlineObject>?) {
   ...
   * @return RequestConfig
   */
  fun pluginUpgradeRequestConfig(name: kotlin.String, remote: kotlin.String, xRegistryAuth: kotlin.String?, body: kotlin.collections.List<InlineObject>?): RequestConfig<kotlin.collections.List<InlineObject>> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        put("remote", listOf(remote.toString()))

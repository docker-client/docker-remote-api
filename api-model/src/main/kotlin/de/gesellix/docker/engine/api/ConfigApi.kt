...
class ConfigApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
   ...
   */
  fun configCreateRequestConfig(body: UNKNOWN_BASE_TYPE?): RequestConfig<UNKNOWN_BASE_TYPE> {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun configDelete(id: kotlin.String) {
   ...
   * @return RequestConfig
   */
  fun configDeleteRequestConfig(id: kotlin.String): RequestConfig<Unit> {
  ...
  fun configInspect(id: kotlin.String): Config {
    ...
    val localVarResponse = request<Unit, Config>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun configInspectRequestConfig(id: kotlin.String): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
  ...
  fun configList(filters: kotlin.String?): kotlin.collections.List<Config> {
    ...
    val localVarResponse = request<Unit, kotlin.collections.List<Config>>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun configListRequestConfig(filters: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun configUpdate(id: kotlin.String, version: kotlin.Long, body: ConfigSpec?) {
    val localVariableConfig = configUpdateRequestConfig(id = id, version = version, body = body)

    val localVarResponse = request<ConfigSpec, Unit>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun configUpdateRequestConfig(id: kotlin.String, version: kotlin.Long, body: ConfigSpec?): RequestConfig<ConfigSpec> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {

...
class NodeApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun nodeDelete(id: kotlin.String, force: kotlin.Boolean?) {
   ...
   */
  fun nodeDeleteRequestConfig(id: kotlin.String, force: kotlin.Boolean?): RequestConfig<Unit> {
  ...
  fun nodeInspect(id: kotlin.String): Node {
    ...
    val localVarResponse = request<Unit, Node>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun nodeInspectRequestConfig(id: kotlin.String): RequestConfig<Unit> {
    val localVariableBody = null
  ...
  fun nodeList(filters: kotlin.String?): kotlin.collections.List<Node> {
    ...
    val localVarResponse = request<Unit, kotlin.collections.List<Node>>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun nodeListRequestConfig(filters: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        if (filters != null) {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun nodeUpdate(id: kotlin.String, version: kotlin.Long, body: NodeSpec?) {
    val localVariableConfig = nodeUpdateRequestConfig(id = id, version = version, body = body)

    val localVarResponse = request<NodeSpec, Unit>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun nodeUpdateRequestConfig(id: kotlin.String, version: kotlin.Long, body: NodeSpec?): RequestConfig<NodeSpec> {

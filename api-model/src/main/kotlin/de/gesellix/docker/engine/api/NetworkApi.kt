...
class NetworkApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun networkConnect(id: kotlin.String, container: InlineObject3) {
    val localVariableConfig = networkConnectRequestConfig(id = id, container = container)

    val localVarResponse = request<InlineObject3, Unit>(
      localVariableConfig
    )
   ...
   */
  fun networkConnectRequestConfig(id: kotlin.String, container: InlineObject3): RequestConfig<InlineObject3> {
  ...
  fun networkCreate(networkConfig: InlineObject2): NetworkCreateResponse {
    ...
    val localVarResponse = request<InlineObject2, NetworkCreateResponse>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun networkCreateRequestConfig(networkConfig: InlineObject2): RequestConfig<InlineObject2> {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun networkDelete(id: kotlin.String) {
   ...
   * @return RequestConfig
   */
  fun networkDeleteRequestConfig(id: kotlin.String): RequestConfig<Unit> {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun networkDisconnect(id: kotlin.String, container: InlineObject4) {
    val localVariableConfig = networkDisconnectRequestConfig(id = id, container = container)

    val localVarResponse = request<InlineObject4, Unit>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun networkDisconnectRequestConfig(id: kotlin.String, container: InlineObject4): RequestConfig<InlineObject4> {
    val localVariableBody = container
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
   ...
   * @return RequestConfig
   */
  fun networkInspectRequestConfig(id: kotlin.String, verbose: kotlin.Boolean?, scope: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
  ...
  fun networkList(filters: kotlin.String?): kotlin.collections.List<Network> {
    ...
    val localVarResponse = request<Unit, kotlin.collections.List<Network>>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun networkListRequestConfig(filters: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        if (filters != null) {
  ...
  fun networkPrune(filters: kotlin.String?): NetworkPruneResponse {
    ...
    val localVarResponse = request<Unit, NetworkPruneResponse>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun networkPruneRequestConfig(filters: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        if (filters != null) {

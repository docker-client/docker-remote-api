...
class TaskApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun taskInspect(id: kotlin.String): Task {
    ...
    val localVarResponse = request<Unit, Task>(
      localVariableConfig
    )
   ...
   */
  fun taskInspectRequestConfig(id: kotlin.String): RequestConfig<Unit> {
  ...
  fun taskList(filters: kotlin.String?): kotlin.collections.List<Task> {
    ...
    val localVarResponse = request<Unit, kotlin.collections.List<Task>>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun taskListRequestConfig(filters: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
   ...
   * @return RequestConfig
   */
  fun taskLogsRequestConfig(id: kotlin.String, details: kotlin.Boolean?, follow: kotlin.Boolean?, stdout: kotlin.Boolean?, stderr: kotlin.Boolean?, since: kotlin.Int?, timestamps: kotlin.Boolean?, tail: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        if (details != null) {

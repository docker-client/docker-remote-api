...
class SwarmApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun swarmInit(body: InlineObject5): kotlin.String {
    ...
    val localVarResponse = request<InlineObject5, kotlin.String>(
      localVariableConfig
    )
   ...
   */
  fun swarmInitRequestConfig(body: InlineObject5): RequestConfig<InlineObject5> {
  ...
  fun swarmInspect(): Swarm {
    ...
    val localVarResponse = request<Unit, Swarm>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun swarmInspectRequestConfig(): RequestConfig<Unit> {
  ...
  fun swarmJoin(body: InlineObject6) {
    ...
    val localVarResponse = request<InlineObject6, Unit>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun swarmJoinRequestConfig(body: InlineObject6): RequestConfig<InlineObject6> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun swarmLeave(force: kotlin.Boolean?) {
   ...
   * @return RequestConfig
   */
  fun swarmLeaveRequestConfig(force: kotlin.Boolean?): RequestConfig<Unit> {
    val localVariableBody = null
  ...
  fun swarmUnlock(body: InlineObject7) {
    ...
    val localVarResponse = request<InlineObject7, Unit>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun swarmUnlockRequestConfig(body: InlineObject7): RequestConfig<InlineObject7> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
  ...
  fun swarmUnlockkey(): UnlockKeyResponse {
    ...
    val localVarResponse = request<Unit, UnlockKeyResponse>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun swarmUnlockkeyRequestConfig(): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun swarmUpdate(version: kotlin.Long, body: SwarmSpec, rotateWorkerToken: kotlin.Boolean?, rotateManagerToken: kotlin.Boolean?, rotateManagerUnlockKey: kotlin.Boolean?) {
    ...
    val localVarResponse = request<SwarmSpec, Unit>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun swarmUpdateRequestConfig(version: kotlin.Long, body: SwarmSpec, rotateWorkerToken: kotlin.Boolean?, rotateManagerToken: kotlin.Boolean?, rotateManagerUnlockKey: kotlin.Boolean?): RequestConfig<SwarmSpec> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {

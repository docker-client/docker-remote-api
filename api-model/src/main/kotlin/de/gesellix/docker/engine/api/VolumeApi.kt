...
class VolumeApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun volumeCreate(volumeConfig: VolumeConfig): Volume {
    ...
    val localVarResponse = request<VolumeConfig, Volume>(
      localVariableConfig
    )
   ...
   */
  fun volumeCreateRequestConfig(volumeConfig: VolumeConfig): RequestConfig<VolumeConfig> {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun volumeDelete(name: kotlin.String, force: kotlin.Boolean?) {
   ...
   * @return RequestConfig
   */
  fun volumeDeleteRequestConfig(name: kotlin.String, force: kotlin.Boolean?): RequestConfig<Unit> {
  ...
  fun volumeInspect(name: kotlin.String): Volume {
    ...
    val localVarResponse = request<Unit, Volume>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun volumeInspectRequestConfig(name: kotlin.String): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
  ...
  fun volumeList(filters: kotlin.String?): VolumeListResponse {
    ...
    val localVarResponse = request<Unit, VolumeListResponse>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun volumeListRequestConfig(filters: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        if (filters != null) {
  ...
  fun volumePrune(filters: kotlin.String?): VolumePruneResponse {
    ...
    val localVarResponse = request<Unit, VolumePruneResponse>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun volumePruneRequestConfig(filters: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        if (filters != null) {

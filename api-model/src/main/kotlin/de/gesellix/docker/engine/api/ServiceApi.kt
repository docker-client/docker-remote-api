...
class ServiceApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun serviceCreate(body: UNKNOWN_BASE_TYPE, xRegistryAuth: kotlin.String?): ServiceCreateResponse {
    ...
    val localVarResponse = request<UNKNOWN_BASE_TYPE, ServiceCreateResponse>(
      localVariableConfig
    )
   ...
   */
  fun serviceCreateRequestConfig(body: UNKNOWN_BASE_TYPE, xRegistryAuth: kotlin.String?): RequestConfig<UNKNOWN_BASE_TYPE> {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun serviceDelete(id: kotlin.String) {
   ...
   * @return RequestConfig
   */
  fun serviceDeleteRequestConfig(id: kotlin.String): RequestConfig<Unit> {
  ...
  fun serviceInspect(id: kotlin.String, insertDefaults: kotlin.Boolean?): Service {
    ...
    val localVarResponse = request<Unit, Service>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun serviceInspectRequestConfig(id: kotlin.String, insertDefaults: kotlin.Boolean?): RequestConfig<Unit> {
    val localVariableBody = null
  ...
  fun serviceList(filters: kotlin.String?, status: kotlin.Boolean?): kotlin.collections.List<Service> {
    ...
    val localVarResponse = request<Unit, kotlin.collections.List<Service>>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun serviceListRequestConfig(filters: kotlin.String?, status: kotlin.Boolean?): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        if (filters != null) {
   ...
   * @return RequestConfig
   */
  fun serviceLogsRequestConfig(id: kotlin.String, details: kotlin.Boolean?, follow: kotlin.Boolean?, stdout: kotlin.Boolean?, stderr: kotlin.Boolean?, since: kotlin.Int?, timestamps: kotlin.Boolean?, tail: kotlin.String?): RequestConfig<Unit> {
    val localVariableBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {
        if (details != null) {
  ...
  fun serviceUpdate(id: kotlin.String, version: kotlin.Int, body: UNKNOWN_BASE_TYPE, registryAuthFrom: kotlin.String?, rollback: kotlin.String?, xRegistryAuth: kotlin.String?): ServiceUpdateResponse {
    ...
    val localVarResponse = request<UNKNOWN_BASE_TYPE, ServiceUpdateResponse>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun serviceUpdateRequestConfig(id: kotlin.String, version: kotlin.Int, body: UNKNOWN_BASE_TYPE, registryAuthFrom: kotlin.String?, rollback: kotlin.String?, xRegistryAuth: kotlin.String?): RequestConfig<UNKNOWN_BASE_TYPE> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
      .apply {

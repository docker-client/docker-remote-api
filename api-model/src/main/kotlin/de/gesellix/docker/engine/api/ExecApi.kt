...
class ExecApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun containerExec(id: kotlin.String, execConfig: InlineObject): IdResponse {
    ...
    val localVarResponse = request<InlineObject, IdResponse>(
      localVariableConfig
    )
   ...
   */
  fun containerExecRequestConfig(id: kotlin.String, execConfig: InlineObject): RequestConfig<InlineObject> {
  ...
  fun execInspect(id: kotlin.String): ExecInspectResponse {
    ...
    val localVarResponse = request<Unit, ExecInspectResponse>(
      localVariableConfig
    )
   ...
   * @return RequestConfig
   */
  fun execInspectRequestConfig(id: kotlin.String): RequestConfig<Unit> {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun execResize(id: kotlin.String, h: kotlin.Int?, w: kotlin.Int?) {
   ...
   * @return RequestConfig
   */
  fun execResizeRequestConfig(id: kotlin.String, h: kotlin.Int?, w: kotlin.Int?): RequestConfig<Unit> {
    val localVariableBody = null
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun execStart(id: kotlin.String, execStartConfig: InlineObject1?) {
   ...
   * @return RequestConfig
   */
  fun execStartRequestConfig(id: kotlin.String, execStartConfig: InlineObject1?): RequestConfig<InlineObject1> {
